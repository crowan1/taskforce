...
import CreateCategoryModal from '../compenents/dashboard/modal/CreateCategoryModal';
        ...
        <div className="dashboard-container">
                        ...
                        <div className="kanban-header">
                            ...
                            <div className="kanban-actions">
                                ...
                                <button 
                                    ...
                                    onClick={() => {
                                        console.log('Bouton créer catégorie cliqué');
            ...
            {showCreateCategory && (
                <CreateCategoryModal 
                    ...
                    onClose={() => {
                        console.log('Fermeture du modal catégorie');
