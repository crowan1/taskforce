...
import CreateColumnModal from '../compenents/dashboard/CreateColumnModal';
import AddUserModal from '../compenents/dashboard/AddUserModal';
import AddSkillsModal from '../compenents/dashboard/AddSkillsModal';
import EditTaskModal from '../compenents/dashboard/EditTaskModal';
...
const Dashboard = () => {
    ...
    const handleCreateTask = async (taskData) => {
        try {
            ...
            // Attendre un peu puis forcer le rafraîchissement des tâches
            setTimeout(async () => {
    ...
    const handleUpdateTask = async (taskId, taskData) => {
        try {
            const data = await apiCall(`http://localhost:8000/api/tasks/${taskId}`, {
                method: 'PUT',
